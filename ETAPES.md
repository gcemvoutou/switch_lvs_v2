...
La migration a été l'occasion de nettoyer et d'harmoniser le plan de VLANs du site : certains VLANs historiques ont été conservés, d'autres fusionnés ou renumérotés, et trois nouveaux VLANs ont été créés et tagguées pour anticiper des besoins à venir.
 
**📷 Schéma récapitulatif du plan de VLANs**

<img src="images/schema_vlans.png" alt="Schéma VLANs" width="65%">
